export default {
  ...
  email_already_used_error:
    "Бұл электрондық пошта мекенжайы бұрыннан қолданыста",
  ...
  provider_has_future_consultations_error:
    "Консультанттың болашақта консультациялары бар",
  ...
  booking_not_allowed_error: "Сіз бұл уақытқа консультацияға жазылғансыз",
};
