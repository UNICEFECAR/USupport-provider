...
then
    ...
    docker build -t provider:$IMAGE_TAG .
    docker tag provider:$IMAGE_TAG 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-provider-api:$IMAGE_TAG

    # Push image to 
    docker push 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-provider-api:$IMAGE_TAG
